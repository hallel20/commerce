  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-blue max-w-none">
        ...
        <p className="text-gray-600 mb-4">
          We do not sell your personal information. We may share your information with third-party service providers who assist us in operating our website, conducting our business, or serving our users.
        </p>
        ...
        <p className="text-gray-600 mb-4">
          If you have any questions about this privacy policy, please contact us at privacy@modernshop.com.
        </p>
      </div>
    </div>
  );
